...
<vaadin-vertical-layout style="width: 100%;" id="vaadinVerticalLayout">
 <div style="width: 80%; height: 100%; align-self: center; margin-top: var(--lumo-space-xl);" id="div">
  <vaadin-vertical-layout theme="spacing" style="align-items: center; justify-content: center;" id="vaadinVerticalLayout1">
   ...
   <vaadin-text-field style="align-self: center; width: 100%;" placeholder="Contrasena actual" id="contrasenia_actual" class="formulario"></vaadin-text-field>
   <vaadin-text-field style="align-self: center; width: 100%;" placeholder="Nueva contrasena" id="nueva_contrasenia" class="formulario"></vaadin-text-field>
   <vaadin-text-field style="align-self: center; width: 100%;" placeholder="Confirmacion nueva contrasena" id="confirmacion_nueva_contrasenia" class="formulario"></vaadin-text-field>
