...
<vaadin-vertical-layout style="width: 100%;" id="vaadinVerticalLayout">
 ...
 <vaadin-horizontal-layout style="width: 100%; margin: var(--lumo-space-s);" id="vaadinHorizontalLayout">
  <vaadin-vertical-layout style="width: 100%; border-right: 2px solid black; " id="vaadinVerticalLayout1">
 ...
 <vaadin-horizontal-layout style="width: 100%;  " id="vaadinHorizontalLayout1">
  <vaadin-vertical-layout style="width: 100%; border-right: 2px solid black;" id="vaadinVerticalLayout3">
  ...
  <vaadin-vertical-layout style="width: 100%; border-right: 2px solid black;" id="vaadinVerticalLayout4">
  ...
  <vaadin-vertical-layout style="width: 100%;" id="vaadinVerticalLayout5">
