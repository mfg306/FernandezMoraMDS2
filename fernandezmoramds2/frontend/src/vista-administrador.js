...
<vaadin-vertical-layout style="width: 100%;" id="vaadinVerticalLayout">
 ...
 <vaadin-horizontal-layout theme="spacing" style="width: 100%;background-color:#D0D1D1;" id="vaadinHorizontalLayout">
  <vaadin-vertical-layout theme="spacing" style="width: 100%; padding: var(--lumo-space-m);" id="vaadinVerticalLayout1">
   ...
   <vaadin-button theme="primary" style="align-self: center;" id="boton_gestionar_ofertas">
     Gestionar 
   </vaadin-button>
  ...
  <vaadin-vertical-layout theme="spacing" style="width: 100%; padding: var(--lumo-space-m);" id="vaadinVerticalLayout2">
   ...
   <vaadin-button theme="primary" style="align-self: center;" id="boton_gestionar_categorias">
     Gestionar 
   </vaadin-button>
  </vaadin-vertical-layout>
 </vaadin-horizontal-layout>
 <vaadin-horizontal-layout theme="spacing" style="width: 100%; margin-top:20%; background-color:#D0D1D1;" id="vaadinHorizontalLayout1">
  <vaadin-vertical-layout theme="spacing" style="width: 100%; padding: var(--lumo-space-m);" id="vaadinVerticalLayout3">
   ...
   <vaadin-button theme="primary" style="align-self: center;" id="boton_gestionar_productos">
     Gestionar 
   </vaadin-button>
  </vaadin-vertical-layout>
