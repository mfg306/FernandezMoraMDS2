...
<vaadin-vertical-layout style="width: 100%;" id="vaadinVerticalLayout">
 ...
 <vaadin-vertical-layout theme="spacing" style="width: 80%; padding: 10%; align-self: center; background-color: #F1F2F2; " id="vaadinVerticalLayout1">
  <vaadin-text-field style="align-self: center; border-bottom: 2px solid grey; border-radius: 0; padding-bottom: 0; width: 100%;" placeholder="Introducir nuevo correo" id="vaadinTextField1"></vaadin-text-field>
  <vaadin-text-field style="align-self: center; border-bottom: 2px solid grey; border-radius: 0; padding-bottom: 0; width: 100%;" placeholder="Introducir nueva contrasena" id="vaadinTextField"></vaadin-text-field>
  <vaadin-horizontal-layout theme="spacing" style="align-self: center;" id="vaadinHorizontalLayout">
   ...
   <vaadin-button theme="primary" id="vaadinButton1" style="background-color: grey; color: white;">
     Cancelar 
   </vaadin-button>
