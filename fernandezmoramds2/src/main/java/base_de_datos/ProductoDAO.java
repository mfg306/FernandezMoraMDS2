...
public class ProductoDAO {
	...
	public static boolean save(base_de_datos.Producto producto) throws PersistentException {
		try {
			MDS2PersistentManager.instance().saveObject(producto);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(base_de_datos.Producto producto) throws PersistentException {
		try {
			MDS2PersistentManager.instance().deleteObject(producto);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(base_de_datos.Producto producto) throws PersistentException {
		try {
			MDS2PersistentManager.instance().getSession().refresh(producto);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(base_de_datos.Producto producto) throws PersistentException {
		try {
			MDS2PersistentManager.instance().getSession().evict(producto);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
