...
public class URDAO {
	...
	public static boolean save(base_de_datos.UR uR) throws PersistentException {
		try {
			MDS2PersistentManager.instance().saveObject(uR);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(base_de_datos.UR uR) throws PersistentException {
		try {
			MDS2PersistentManager.instance().deleteObject(uR);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(base_de_datos.UR uR) throws PersistentException {
		try {
			MDS2PersistentManager.instance().getSession().refresh(uR);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(base_de_datos.UR uR) throws PersistentException {
		try {
			MDS2PersistentManager.instance().getSession().evict(uR);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
